...
public class WetterdetailActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wetterdetail);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_wetterdetail, menu);
        return true;
    }
    ...
    public static class WetterdetailFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            View rootView = inflater.inflate(R.layout.fragment_wetterdetail, container, false);

            // Die WetterdetailActivity wurde über einen Intent aufgerufen
            ...
            if (empfangenerIntent != null && empfangenerIntent.hasExtra(Intent.EXTRA_TEXT)) {
                ...
                ((TextView) rootView.findViewById(R.id.wetterdetail_text))
                        .setText(wetterinfo);
            }
